...
const PROJECT_NAME = "a90e3c78-1f65-4978-b70e-";
...
const IDEA_BRIEF = "Tu es un expert en création de mini-SaaS viraux, ultra rentables, optimisés pour la pub et la scalabilité.\n\nTâche:\n- À partir de la tendance suivante, conçois un mini-SaaS complet.\n\nTendance:\n\"Nom du mini-SaaS : DancePix\nPromesse principale : Transformez votre photo en vidéo virale où vous dansez sur les tendances TikTok en quelques secondes.\nPain point principal : Créer facilement des vidéos fun et virales sans savoir monter ou filmer, directement à partir d’une simple photo.\nFonctionnalités clés :\n- Upload simple d’une photo et détection automatique du visage\n- Animation IA qui génère une vi";
